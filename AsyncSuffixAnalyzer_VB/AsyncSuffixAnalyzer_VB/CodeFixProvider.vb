...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(AsyncSuffixAnalyzer_VBCodeFixProvider)), [Shared]>
Public Class AsyncSuffixAnalyzer_VBCodeFixProvider
    ...
    Public NotOverridable Overrides ReadOnly Property FixableDiagnosticIds As ImmutableArray(Of String)
        Get
            Return ImmutableArray.Create(AsyncSuffixAnalyzer_VBAnalyzer.DiagnosticId)
        End Get
    End Property
